...
<head>
	...
	<title>AXA Be Surprise - Home</title>
				...
				<div class="row">
					<div class="col-12">
						...
						<div class="content-wrap no-shadow text-center bd-gray detail-item">
							<img src="assets/img/icon/voucher.png" alt="" class="img-fluid">
							<p>Voucher diskon Rp. 5.000 untuk setiap pembelian di lokasi merchant yang berpartisipasi.</p>
						</div>
						<div class="content-wrap no-shadow text-center bd-gray detail-item">
							<img src="assets/img/icon/merchant.png" alt="" class="img-fluid">
							<p>Voucher diskon Rp. 5.000 untuk setiap pembelian di lokasi merchant yang berpartisipasi.</p>
						</div>
						<div class="content-wrap no-shadow text-center bd-gray detail-item">
							<img src="assets/img/icon/discount.png" alt="" class="img-fluid">
							<p>Diskon hingga 70% untuk pendaftaran menjadi onlinepreneur di BeonCo.com</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="container-fluid merchant">
				<div class="row">
					<div class="col-10 offset-1 text-center">
						...
						<div class="row">
							<div class="col-6 text-center"><img src="assets/img/logo-starbucks.png" alt="" class="img-fluid logo"></div>
							<div class="col-6 text-center"><img src="assets/img/logo-excelso.png" alt="" class="img-fluid logo"></div>
							<div class="col-6 text-center"><img src="assets/img/logo-the-coffee-bean.png" alt="" class="img-fluid logo"></div>
							<div class="col-6 text-center"><img src="assets/img/logo-chatime.png" alt="" class="img-fluid logo"></div>
						</div>
					</div>
				</div>
			</div>
